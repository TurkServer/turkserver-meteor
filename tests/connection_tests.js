...
Tinytest.add(
  "connection - get existing assignment creates and preserves object",
...
Tinytest.add(
  "connection - assignment object preserved upon creation",
  withCleanup(function(test) {
...
Tinytest.add(
  "connection - get active user assignment",
  withCleanup(function(test) {
    asst = createAssignment();
...
Tinytest.add(
  "connection - assignment removed from cache after return",
  withCleanup(function(test) {
    asst = createAssignment();
    asst.setReturned();
...
Tinytest.add(
  "connection - assignment removed from cache after completion",
  withCleanup(function(test) {
    asst = createAssignment();
    asst.showExitSurvey();
    asst.setCompleted({});
...
Tinytest.add(
  "connection - user added to lobby",
  withCleanup(function(test) {
    asst = createAssignment();
...
Tinytest.add(
  "connection - user disconnecting and reconnecting to lobby",
  withCleanup(function(test) {
    asst = createAssignment();
...
Tinytest.add(
  "connection - user sent to exit survey",
  withCleanup(function(test) {
    asst = createAssignment();
    asst.showExitSurvey();
...
Tinytest.add(
  "connection - user submitting HIT",
  withCleanup(function(test) {
    asst = createAssignment();
...
Tinytest.add(
  "connection - improper submission of HIT",
  withCleanup(function(test) {
    asst = createAssignment();
...
Tinytest.add(
  "connection - set assignment as returned",
  withCleanup(function(test) {
    asst = createAssignment();
    TestUtils.connCallbacks.sessionReconnect({ userId });
...
Tinytest.add(
  "connection - user resuming into instance",
  withCleanup(function(test) {
    asst = createAssignment();
...
Tinytest.add(
  "connection - user resuming into exit survey",
  withCleanup(function(test) {
    asst = createAssignment();
    Meteor.users.update(userId, {
      $set: {
...
Tinytest.add(
  ...
  withCleanup(function(test) {
    ...
    asst.addPayment(1.5);
    return test.equal(asst.getPayment(), 2.5);
  })
);

Tinytest.add(
  "connection - increment null payment amount",
  withCleanup(function(test) {
    asst = createAssignment();
    test.isFalse(asst.getPayment());
...
Tinytest.add(
  "connection - throw on set/inc payment when bonus paid",
  withCleanup(function(test) {
    asst = createAssignment();
    ...
    test.throws(() => asst.addPayment(1.5));
    return test.equal(asst.getPayment(), 0.01);
  })
);

Tinytest.add(
  "connection - throw on double payments",
  withCleanup(function(test) {
    asst = createAssignment();
